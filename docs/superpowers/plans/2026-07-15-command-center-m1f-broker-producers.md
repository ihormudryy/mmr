...
- Every materialized mutation and its journal row commit through one `DuckDBConnection.transaction` call; producers never call `DomainJournal.mutate` outside it.
